...
export async function GET(request: Request) {
  try {
    ...
    const [
      ...
      usersFilter ? prisma.user.findMany({ where: usersFilter }) : [],
      ...
      applicantsFilter ? prisma.applicant.findMany({ where: applicantsFilter, orderBy: { createdAt: "desc" } }) : [],
      ...
      payrollFilter ? prisma.payrollRecord.findMany({ where: payrollFilter }) : [],
      ...
      hasReportsView ? prisma.activityLog.findMany({ where: { ...tenantFilter, archived: false }, orderBy: { dateTime: "desc" }, take: 200 }) : [],
      hasReportsView ? prisma.activityLog.findMany({ where: { ...tenantFilter, archived: true }, orderBy: { dateTime: "desc" }, take: 200 }) : [],
      ...
      emailsFilter ? prisma.sentEmail.findMany({ where: emailsFilter }) : [],
      emailsFilter ? prisma.sentWhatsApp.findMany({ where: emailsFilter }) : [],
